...
namespace SSCore
{
    public class AsyncSocketSession : SocketSession, IAsyncSocketSession
    {
        ...
        private void StartReceive(SocketAsyncEventArgs e, int offsetDelta)
        {
            ...
            try
            {
                if (offsetDelta < 0 || offsetDelta >= 4096) //Config.ReceiveBufferSize)
                ...
                {
                    e.SetBuffer(predictOffset, 4096 - offsetDelta); // Config.ReceiveBufferSize - offsetDelta);
                }
