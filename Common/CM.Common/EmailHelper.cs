...
namespace CM.Common
{
            ...
            try
            {
                if (mMailMessage != null)
                {
                    mSmtpClient = new SmtpClient
                    {
                        ...
                        Host = this.mSenderServerHost,
                        Port = this.mSenderPort,
                        UseDefaultCredentials = false,
                        EnableSsl = this.mEnableSsl
                    };
    ...
    {
        public static void SendEmail(string toMailAddress, string subjectInfo, string bodyInfo)
        {
            try
            {

                //string senderServerIp = "smtp.qq.com";
                //string senderServerIp = System.Configuration.ConfigurationManager.AppSettings["smtpServer"] ?? "smtp.sina.com";

                //string fromMailAddress = System.Configuration.ConfigurationManager.AppSettings["fromAddress"] ?? "ccobserver@sina.com";

                //string mailUsername = System.Configuration.ConfigurationManager.AppSettings["mailUsername"] ?? "ccobserver";
                //string mailPassword = System.Configuration.ConfigurationManager.AppSettings["mailPassword"] ?? "123.com"; //发送邮箱的密码（）
                //string mailPort = System.Configuration.ConfigurationManager.AppSettings["mailPort"] ?? "25";
